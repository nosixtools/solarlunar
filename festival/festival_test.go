...
func TestGetFestivals(t *testing.T) {
	...
	fmt.Println(festival.GetFestivals("2019-11-28"))
	fmt.Println(festival.GetFestivals("2019-09-22"))
	fmt.Println(festival.GetFestivals("2020-11-26"))
	fmt.Println(festival.GetFestivals("2020-09-27"))
}
